...
if [ -f "$CACHE/os-info.sh" ]; then
        ...
        Linux*)
            case "$(uname -o)" in
                Android*) # --- Android ---
                    ...
                    android_brand="$(/system/bingetprop ro.product.brand)"
                    case "$android_brand" in
                         google) ANDROID_BRAND_COLOR_BASE16=12 ANDROID_BRAND_COLOR_XTERM256=69 ANDROID_BRAND_COLOR_RGB='#3081f7';;
                         samsung) ANDROID_BRAND_COLOR_BASE16='blue' ANDROID_BRAND_COLOR_XTERM256=18 ANDROID_BRAND_COLOR_RGB='#0c2086';;
                         xiaomi) ANDROID_BRAND_COLOR_BASE16='green' ANDROID_BRAND_COLOR_XTERM256=202 ANDROID_BRAND_COLOR_RGB='#f66602';;
                         huawei) ANDROID_BRAND_COLOR_BASE16='green' ANDROID_BRAND_COLOR_XTERM256=9 ANDROID_BRAND_COLOR_RGB='#f7111b';;
                         oppo) ANDROID_BRAND_COLOR_BASE16='black' ANDROID_BRAND_COLOR_XTERM256=23 ANDROID_BRAND_COLOR_RGB='#036730';;
                         vivo) ANDROID_BRAND_COLOR_BASE16='blue' ANDROID_BRAND_COLOR_XTERM256=63 ANDROID_BRAND_COLOR_RGB='#415bf7';;
                         OnePlus) ANDROID_BRAND_COLOR_BASE16='red' ANDROID_BRAND_COLOR_XTERM256='red' ANDROID_BRAND_COLOR_RGB='#ce0021';;
                         motorola) ANDROID_BRAND_COLOR_BASE16='blue' ANDROID_BRAND_COLOR_XTERM256=25 ANDROID_BRAND_COLOR_RGB='#035ca1';;
                         realme) ANDROID_BRAND_COLOR_BASE16='yellow' ANDROID_BRAND_COLOR_XTERM256='yellow' ANDROID_BRAND_COLOR_RGB='#f6c114';;
                         honor) ANDROID_BRAND_COLOR_BASE16=14 ANDROID_BRAND_COLOR_XTERM256=38 ANDROID_BRAND_COLOR_RGB='#05bbdf';;
                         nokia) ANDROID_BRAND_COLOR_BASE16='blue' ANDROID_BRAND_COLOR_XTERM256=24 ANDROID_BRAND_COLOR_RGB='#1c468b';;
                         sony) ANDROID_BRAND_COLOR_BASE16='blue' ANDROID_BRAND_COLOR_XTERM256='blue' ANDROID_BRAND_COLOR_RGB='#36388c';;
                         lg) ANDROID_BRAND_COLOR_BASE16='red' ANDROID_BRAND_COLOR_XTERM256=125 ANDROID_BRAND_COLOR_RGB='#a80033';;
                         htc) ANDROID_BRAND_COLOR_BASE16=10 ANDROID_BRAND_COLOR_XTERM256='green' ANDROID_BRAND_COLOR_RGB='#34a708';;
                         asus) ANDROID_BRAND_COLOR_BASE16='blue' ANDROID_BRAND_COLOR_XTERM256=24 ANDROID_BRAND_COLOR_RGB='#035093';;
                         lenovo) ANDROID_BRAND_COLOR_BASE16='red' ANDROID_BRAND_COLOR_XTERM256=160 ANDROID_BRAND_COLOR_RGB='#e10112';;
                         techo) ANDROID_BRAND_COLOR_BASE16='cyan' ANDROID_BRAND_COLOR_XTERM256=32 ANDROID_BRAND_COLOR_RGB='#018ed7';;
                         infinix) ANDROID_BRAND_COLOR_BASE16=10 ANDROID_BRAND_COLOR_XTERM256=106 ANDROID_BRAND_COLOR_RGB='#7dbd1b';;
                         itel) ANDROID_BRAND_COLOR_BASE16='green' ANDROID_BRAND_COLOR_XTERM256=9 ANDROID_BRAND_COLOR_RGB='#f10235';;
                         micromax) ANDROID_BRAND_COLOR_BASE16='green' ANDROID_BRAND_COLOR_XTERM256=172 ANDROID_BRAND_COLOR_RGB='#ea742d';;
                         lava) ANDROID_BRAND_COLOR_BASE16='green' ANDROID_BRAND_COLOR_XTERM256=161 ANDROID_BRAND_COLOR_RGB='#e71454';;
                         karbonn) ANDROID_BRAND_COLOR_BASE16='green' ANDROID_BRAND_COLOR_XTERM256=9 ANDROID_BRAND_COLOR_RGB='#f6181b';;
                         qmobile) ANDROID_BRAND_COLOR_BASE16='green' ANDROID_BRAND_COLOR_XTERM256=125 ANDROID_BRAND_COLOR_RGB='#be044e';;
                         symphony) ANDROID_BRAND_COLOR_BASE16='red' ANDROID_BRAND_COLOR_XTERM256=196 ANDROID_BRAND_COLOR_RGB='#f50100';;
                         coolpad) ANDROID_BRAND_COLOR_BASE16='blue' ANDROID_BRAND_COLOR_XTERM256=25 ANDROID_BRAND_COLOR_RGB='#0042a3';;
                         cubot) ANDROID_BRAND_COLOR_BASE16=14 ANDROID_BRAND_COLOR_XTERM256=14 ANDROID_BRAND_COLOR_RGB='#3cbfed';;
                         ulefone) ANDROID_BRAND_COLOR_BASE16='yellow' ANDROID_BRAND_COLOR_XTERM256='yellow' ANDROID_BRAND_COLOR_RGB='#f6c307';;
                         umidigi) ANDROID_BRAND_COLOR_BASE16='red' ANDROID_BRAND_COLOR_XTERM256=196 ANDROID_BRAND_COLOR_RGB='#ed0413';;
                         oukitel) ANDROID_BRAND_COLOR_BASE16='green' ANDROID_BRAND_COLOR_XTERM256=166 ANDROID_BRAND_COLOR_RGB='#e86600';;
                         blu) ANDROID_BRAND_COLOR_BASE16='cyan' ANDROID_BRAND_COLOR_XTERM256=31 ANDROID_BRAND_COLOR_RGB='#0289a5';;
                         fairphone) ANDROID_BRAND_COLOR_BASE16=12 ANDROID_BRAND_COLOR_XTERM256=74 ANDROID_BRAND_COLOR_RGB='#309ed3';;
                         nothing) ANDROID_BRAND_COLOR_BASE16=15 ANDROID_BRAND_COLOR_XTERM256=15 ANDROID_BRAND_COLOR_RGB='#e9e9e9';;
                         *) ANDROID_BRAND_COLOR_BASE16=8 ANDROID_BRAND_COLOR_XTERM256=236 ANDROID_BRAND_COLOR_RGB='#2c2c2e';;
                    esac;;
    ...
    case "$ANDROID_BRAND_COLOR_RGB" in
        [!0-9]*) _ANDROID_BRAND_COLOR_RGB="'$ANDROID_BRAND_COLOR_RGB'";;
        *)       _ANDROID_BRAND_COLOR_RGB="$ANDROID_BRAND_COLOR_RGB";;
    esac
    case "$ANDROID_BRAND_COLOR_XTERM" in
        [!0-9]*) _ANDROID_BRAND_COLOR_XTERM="'$ANDROID_BRAND_COLOR_XTERM'";;
        *)       _ANDROID_BRAND_COLOR_XTERM="$ANDROID_BRAND_COLOR_XTERM";;
    esac
    case "$ANDROID_BRAND_COLOR_BASE16" in
        [!0-9]*) _ANDROID_BRAND_COLOR_BASE16="'$ANDROID_BRAND_COLOR_BASE16'";;
        *)       _ANDROID_BRAND_COLOR_BASE16="$ANDROID_BRAND_COLOR_BASE16";;
    esac
...
OS_COLOR_BASE16=$_OS_COLOR_BASE16${android_brand:+"
ANDROID_BRAND='$android_brand'
ANDROID_BRAND_COLOR_RGB=$_ANDROID_BRAND_COLOR_RGB
ANDROID_BRAND_COLOR_XTERM=$_ANDROID_BRAND_COLOR_XTERM
ANDROID_BRAND_COLOR_BASE16=$_ANDROID_BRAND_COLOR_BASE16"}
EOF
fi
