...
alias e='exit' q='exit' :q='exit' ls='ls --color=auto -h' la='ls -a' ll='ls -al' lA='ls -A' lL='ls -Al' l='ls -A' clear='reset' cls='reset' c='reset' g='git' ga='git add' ga.='git add .' gc='git commit --verbose' gC='ga. && gc' gp='git push' gr='git remote' gl='git pull' gb='git branch' gco='git checkout' gs='git switch' grs='git restore' gst='git status' md='mkdir -p' p='poweroff' sudo='sudo ' s='sudo' _='sudo' grep='grep --color=auto --exclude-dir={.bzr,CVS,.git,.hg,.svn,.idea,.tox,.venv,venv}' egrep='grep -E' pacman='pacman --color=auto' paru='paru --color=auto' code='code-oss' clang-and9='/opt/android-ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android28-clang' clang-and9-x86='/opt/android-ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi28-clang' clang++-and9='/opt/android-ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android28-clang++' clang++-and9-x86='/opt/android-ndk/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi28-clang++' ...='../..' ....='../../..' .....='../../../..' ......='../../../../..' .......='../../../../../..' ........='../../../../../../..' buildconf='${XDG_CONFIG_HOME:-$HOME/.config}/dotfiles/buildconf.sh' confconf='${XDG_CONFIG_HOME:-$HOME/.config}/dotfiles/confconf.sh' editconf='${XDG_CONFIG_HOME:-$HOME/.config}/dotfiles/editconf.sh' editbuild='${XDG_CONFIG_HOME:-$HOME/.config}/dotfiles/editbuild.sh'
dot() {
...
export PATH="$HOME/.local/bin:$PATH" DOT="${XDG_CONFIG_HOME:-$HOME/.config}/dotfiles"
