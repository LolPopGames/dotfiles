...
# --- Variables ---
ZDIR="${XDG_CONFIG_HOME:-$HOME/.config}/dotfiles/zsh"
SRC="$ZDIR/src"
OUTPUT="${ZDOTDIR:-$HOME}/.zshrc"

# --- Loading Config & Modules ---
source "$ZDIR/config.zsh"
...
case "$OS_NAME" in
    debian|peppermint|neptune|bunsenlabs|antix|crunchbangplusplus|sparky|whonix|pureos|q4os|endless) OS_COLOR_RGB='#a7002e' OS_COLOR_XTERM=124 OS_COLOR_BASE16='red' OS_ICON='';;
